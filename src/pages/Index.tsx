...
const Index = () => {
  ...
  return (
    <div className="min-h-screen">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6 animate-fade-in">
              ...
              <div className="flex flex-wrap gap-4">
                <Button 
                  size="lg" 
                  className="bg-[#25D366] hover:bg-[#128C7E] text-white text-lg px-8 shadow-lg hover:shadow-xl transition-all duration-300 flex items-center gap-2"
                  onClick={() => window.open('https://wa.me/79808654280?text=Здравствуйте!%20Хочу%20записаться%20на%20фотосессию', '_blank')}
                >
      ...
      <section id="contest" className="py-20 px-4 bg-gradient-to-br from-primary/5 via-secondary/5 to-accent/5 relative overflow-hidden">
        <div className="absolute top-0 right-0 w-96 h-96 bg-primary/10 rounded-full blur-3xl"></div>
        <div className="absolute bottom-0 left-0 w-96 h-96 bg-secondary/10 rounded-full blur-3xl"></div>
        <div className="container mx-auto relative z-10">
          <div className="text-center mb-12">
            <Badge className="mb-4 bg-gradient-to-r from-primary to-secondary text-white text-base px-6 py-2">
              🎉 Специальное предложение
            </Badge>
            <h2 className="text-5xl md:text-6xl font-bold font-heading mb-4 bg-gradient-to-r from-primary via-secondary to-accent bg-clip-text text-transparent">
              Конкурс "Креативная фотосессия"
            </h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Победитель получит бесплатную профессиональную фотосессию на тему по своему выбору! 
              Участвовать просто — расскажите о своей идее креативной фотосессии.
            </p>
          </div>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="font-bold text-lg mb-2">Ваша идея</h3>
                      <p className="text-muted-foreground">Опишите концепцию съёмки, которая давно живёт в вашей голове</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">Укажите желаемые цвета и настроение снимков</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="font-bold text-lg mb-2">Уникальность</h3>
                      <p className="text-muted-foreground">Чем креативнее идея — тем больше шансов победить!</p>
                    </div>
                  </div>
                </div>
                
                <div className="flex flex-col justify-center items-center bg-gradient-to-br from-primary/5 to-secondary/5 rounded-2xl p-8 space-y-6">
                  <div className="text-center">
                    <div className="text-6xl font-bold text-primary mb-2">1</div>
                    <p className="text-lg font-semibold">Победитель</p>
                  </div>
                  <div className="w-full h-px bg-gradient-to-r from-transparent via-primary to-transparent"></div>
                  <div className="text-center space-y-2">
                    <p className="text-2xl font-bold">Бесплатная фотосессия</p>
                    <p className="text-muted-foreground">+ Обработка всех фото</p>
                    <p className="text-muted-foreground">Стоимость: от 5000₽</p>
                  </div>
                </div>
              </div>
              
              <div className="border-t pt-8">
                <h3 className="text-2xl font-bold font-heading mb-6 text-center">Как участвовать?</h3>
                <div className="grid md:grid-cols-3 gap-6 mb-8">
                  <div className="text-center space-y-3">
                    ...
                    <h4 className="font-semibold">Напишите в WhatsApp</h4>
                    <p className="text-sm text-muted-foreground">Нажмите на кнопку ниже</p>
                  </div>
                  <div className="text-center space-y-3">
                    ...
                    <h4 className="font-semibold">Расскажите идею</h4>
                    <p className="text-sm text-muted-foreground">Опишите концепцию и цвета</p>
                  </div>
                  <div className="text-center space-y-3">
                    ...
                    <h4 className="font-semibold">Ждите результаты</h4>
                    <p className="text-sm text-muted-foreground">Я выберу победителя</p>
                  </div>
                </div>
                
                <Button 
                  size="lg" 
                  className="w-full bg-[#25D366] hover:bg-[#128C7E] text-white text-xl py-6 shadow-xl hover:shadow-2xl transition-all duration-300 flex items-center justify-center gap-3"
                  onClick={() => window.open('https://wa.me/79808654280?text=Здравствуйте!%20Хочу%20участвовать%20в%20конкурсе%20%22Креативная%20фотосессия%22.%20Моя%20идея:', '_blank')}
                >
                  <Icon name="MessageCircle" size={24} />
                  Отправить заявку на участие в WhatsApp
                </Button>
                
                <p className="text-center text-sm text-muted-foreground mt-4">
                  Конкурс действует до конца месяца. Победитель будет объявлен в социальных сетях.
                </p>
              </div>
            </CardContent>
          </Card>
        ...
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12 max-w-4xl mx-auto">
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 rounded-xl bg-[#25D366] flex items-center justify-center flex-shrink-0 cursor-pointer hover:bg-[#128C7E] transition-colors" onClick={() => window.open('https://wa.me/79808654280', '_blank')}>
                  <Icon name="MessageCircle" className="text-white" size={24} />
                </div>
                <div>
                  <h3 className="font-semibold mb-1">WhatsApp</h3>
                  <p className="text-muted-foreground cursor-pointer hover:text-[#25D366] transition-colors" onClick={() => window.open('https://wa.me/79808654280', '_blank')}>{content.contacts.phone}</p>
                  <p className="text-xs text-muted-foreground mt-1">Нажмите для быстрой связи</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 rounded-xl bg-primary/10 flex items-center justify-center flex-shrink-0">
